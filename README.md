...
`agenticlens` (profiler/reporting engine — already built, unchanged).
...
**Deliverables:**
- [ ] `agentic-chaos.chaos` module + CLI subcommand
- [ ] `chaos_events` schema extension (documented)
- [ ] AgenticLens `ChaosImpactRecommender` adapter
- [ ] README section + 1 example script + demo GIF
